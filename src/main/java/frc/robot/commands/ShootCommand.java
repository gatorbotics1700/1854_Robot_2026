...
public class ShootCommand extends Command {
    ...
    public void execute() {
        ...
        // keep these if statements to make sure the floor and divider motor are only
        // running if shooter is warmed up
        ...
        // this use case is to stop all non-shooter thingselse
        if (dividerVoltage == 0) {
            shooterSubsystem.moveDividerMotor(dividerVoltage);
